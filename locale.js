...
export const EN_MESSAGES = Object.freeze({
    ...
    "document.title": "zeitplural — time, tasks, expenses → Git",

    "nav.application": "Application navigation",
    "nav.home": "zeitplural home",
    "nav.views": "Views",
    ...
    "landing.toGit": "> Git",
    "landing.lede": "zeitplural is a static application. It reads and writes versioned workspace files directly in a Git repository you choose; zeitplural.io has no data backend.",
    ...
    "landing.architectureAlt": "Static hosting loads zeitplural in your browser. The browser talks directly to a Git provider API, which reads and writes your private workspace repository.",
    ...
    "landing.similarIntro": "No direct equivalent surfaced in this review. These projects overlap with zeitplural in scope or storage model.",
    ...
    "workspace.createMeta": "Create and initialize a repository without a zeitplural backend.",
    ...
    "workspace.capabilityHelp": "Use a dedicated, expiring, least-privilege token for exactly this repository. zeitplural cannot mint or restrict a token for you.",
    ...
    "workspace.gitlabScope": "GitLab OAuth requests API access so zeitplural can create, initialize, read, and write the private project.",
    ...
    "error.repositoryExample": "Use a repository URL such as https://github.com/you/zeitplural-data.",
...
export const DE_MESSAGES = Object.freeze({
    ...
    "document.title": "zeitplural — Zeiterfassung, Aufgaben, Ausgaben → Git",

    "nav.application": "Anwendungsnavigation",
    "nav.home": "zeitplural Startseite",
    "nav.views": "Ansichten",
    ...
    "landing.toGit": "→ Git",
    "landing.lede": "zeitplural ist eine statische Anwendung. Sie liest und schreibt versionierte Arbeitsbereichsdateien direkt in ein Git-Repository deiner Wahl; zeitplural.io hat kein Daten-Backend.",
    ...
    "landing.architectureAlt": "Statisches Hosting lädt zeitplural in deinen Browser. Der Browser spricht direkt mit der API eines Git-Anbieters, die dein privates Arbeitsbereichs-Repository liest und schreibt.",
    ...
    "landing.similarIntro": "Bei dieser Recherche fand sich kein direktes Gegenstück. Diese Projekte überschneiden sich mit zeitplural beim Umfang oder Speichermodell.",
    ...
    "workspace.createMeta": "Erstelle und initialisiere ein Repository ohne zeitplural-Backend.",
    "workspace.repositoryName": "Repository-Name",
    ...
    "workspace.capabilityHelp": "Verwende ein eigenes, ablaufendes Token mit den geringstmöglichen Rechten nur für dieses Repository. zeitplural kann Tokens weder ausstellen noch einschränken.",
    ...
    "workspace.gitlabScope": "GitLab-OAuth fordert API-Zugriff an, damit zeitplural das private Projekt erstellen, initialisieren, lesen und schreiben kann.",
    ...
    "error.repositoryExample": "Verwende eine Repository-URL wie https://github.com/du/zeitplural-data.",
...
const EXACT_ERROR_KEYS = new Map([
    ...
    ["Use a repository URL such as https://github.com/you/zeitplural-data.", "error.repositoryExample"],
