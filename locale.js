...
export const EN_MESSAGES = Object.freeze({
    "workspaceSessions.saveCountdown": "Save Changes",
    "workspaceSessions.autosaveCountdown": "Autosave in {seconds}s",
    "workspaceSessions.retryIn": "Retry in {seconds}s",
    "workspaceSessions.retryCountdown": "Retry",
    "workspaceSessions.reconnectAction": "Reconnect",
    "workspaceSessions.savingShort": "Saving…",
    "workspaceSessions.autosaveHelp": "Click to save now (Ctrl+S). Autosave runs 60 seconds after the latest edit.",
    "workspaceSessions.reconnect": "Reconnect this workspace in Workspace settings.",
    "workspaceSessions.saving": "Saving workspaces…",
    "workspaceSessions.changed": "Changed · {count}",
    "workspaceSessions.all": "All workspaces",
    "workspaceSessions.workspace": "Workspace",
    "workspaceSessions.loading": "Opening other workspaces…",
    "workspaceSessions.closeTitle": "Close {workspace}",
    "workspaceSessions.saveClose": "Save and close",
    "workspaceSessions.saveAll": "Save all open workspaces",
    "workspaceSessions.saveFailed": "Save failed · {workspaces}",
    "workspaceSessions.cancel": "Cancel",
    "workspaceSessions.pending": "Some changes could not be saved. Resolve the error and try again.",
    "workspaceSessions.unavailable": "Unavailable workspaces: {workspaces}",
    "workTime.employer": "Employer",
    "workTime.newEmployer": "New employer",
    "workTime.outsideWeek": "inactive this week",
    "workTime.addEmployer": "Add employer",
    "workTime.bulkStatus": "Bulk leave status",
    "workTime.bulkHalf": "Apply to halves",
    "workTime.fullDay": "Full day",
    "workTime.firstHalf": "First half",
    "workTime.secondHalf": "Second half",
    "workTime.selectWorkdays": "Select scheduled workdays",
    "workTime.applySelected": "Apply to selected days",
    "workTime.select": "Select",
    "workTime.day": "Day",
    "workTime.scheduled": "Scheduled hours",
    "workTime.required": "Required hours",
    "workTime.comment": "Comment",
    "workTime.work": "Work",
    "workTime.pto": "Vacation",
    "workTime.sick": "Sick leave",
    "workTime.holiday": "Holiday",
    "workTime.flex": "Time off in lieu",
    "workTime.off": "Not scheduled",
    "workTime.short.work": "Work",
    "workTime.short.pto": "PTO",
    "workTime.short.sick": "Sick",
    "workTime.short.holiday": "Holiday",
    "workTime.short.flex": "TOIL",
    "workTime.short.off": "Off",
    "workTime.employerCount": "{count} employers",
    "workTime.editDay": "Edit daily work and leave",
    "week.chooseDate": "Jump to a date",
    "week.date": "Date",
    "week.goToDate": "Show week",
    "workTime.flexHelp": "Time off in lieu keeps required hours unchanged. Unworked hours use overtime, not vacation days.",
    "workTime.settings": "Employer, schedule & vacation settings",
    "workTime.name": "Employer name",
    "workTime.activeFrom": "Employment starts",
    "workTime.activeUntil": "Employment ends (optional)",
    "workTime.trackingStart": "Accounting starts",
    "workTime.openingOvertime": "Opening overtime (hours)",
    "workTime.openingVacation": "Opening vacation carry-in (days)",
    "workTime.projects": "Assigned projects",
    "workTime.filterProjects": "Filter projects",
    "workTime.schedules": "Effective-dated schedules",
    "workTime.effectiveFrom": "Effective from",
    "workTime.remove": "Remove",
    "workTime.addSchedule": "Add schedule change",
    "workTime.allowances": "Annual vacation allowances",
    "workTime.allowancesHelp": "Enter each year's allowance explicitly. Unused days carry over; schedule changes never prorate the allowance.",
    "workTime.year": "Year",
    "workTime.addAllowance": "Add year",
    "workTime.invalidYear": "Enter a year between 1900 and 2199.",
    "workTime.adjustments": "Vacation balance adjustments",
    "workTime.date": "Date",
    "workTime.days": "days",
    "workTime.addAdjustment": "Add adjustment",
    "workTime.billable": "Billable",
    "workTime.weekDelta": "Week delta through today",
    "workTime.overtime": "Accumulated overtime",
    "workTime.vacationBalance": "Vacation balance",
    "workTime.taken": "Taken",
    "workTime.planned": "Planned",
    "workTime.unplanned": "Unplanned",
    "workTime.vacationCalculation": "How this is calculated",
    "workTime.vacationOverview": "PTO dates this year",
    "workTime.vacationEmpty": "No PTO taken or planned for this year.",
    "workTime.vacationShowDate": "Show this date in the daily editor (keeps unsaved changes)",
    "workTime.vacationBudget": "Carryover: {carryover} days · Allowance: {allowance} days · Adjustments: {adjustments} days",
    "workTime.vacationPlanningHelp": "Current calendar year, independent of the displayed week. Taken includes today; Planned includes future PTO; Unplanned is what remains after all bookings. Only scheduled workdays count.",
    "workTime.missingAllowances": "Annual allowance not configured for:",
    "workTime.noProjects": "No projects assigned: no recorded work will count for this employer.",
    "workTime.legacyReadOnly": "Historical weekly requirements are read-only. Convert them in the data repository before editing employer accounts.",
    "workTime.saving": "A save is already in progress. Please wait.",
    ...
    "settings.meta": "Applies to this browser, across all workspaces.",
    ...
    "landing.openSharedWorkspace": "Open shared link / QR",
    ...
    "workspace.capabilityLink": "Capability link",
    "workspace.scanQr": "Scan QR",
    "workspace.openCapability": "Open link",
    "workspace.scanQrTitle": "Scan capability QR",
    "workspace.scanQrHelp": "Point the rear camera at a QR code containing a zeitberg capability link.",
    "workspace.stopScanning": "Stop scanning",
    "workspace.qrImageHelp": "No camera? Choose a QR image from this device.",
    "workspace.chooseQrImage": "Choose QR image",
    "workspace.connectManually": "or connect manually",
    "workspace.capabilityRequired": "Paste or scan a capability link.",
    "workspace.qrUnavailable": "No camera is available. Choose a QR image instead.",
    "workspace.qrImageError": "No capability QR could be read from that image: {error}",
    "workspace.qrCameraError": "The camera could not be started: {error}",
    ...
    "workspace.capabilityHelp": "Uses this browser's current workspace credential. Ensure it has only the access you intend to share.",
    "workspace.copyCapability": "Copy capability link",
    "workspace.capabilityHostedOnly": "Capability links are available only for hosted workspaces.",
    "workspace.capabilityCredentialMissing": "Reconnect this workspace before sharing a capability link.",
    ...
    "todo.nonDueFallback": "No current tasks match this project. Showing non-due tasks.",
    "demo.try": "Try the playground — no account needed",
    "demo.title": "Playground",
    "demo.notice": "Playground · fictional data · changes disappear on reload",
    "demo.reset": "Reset",
    "demo.exit": "Exit demo",
    "demo.noRepository": "This playground has no repository connection. Exit the demo to connect your own workspace.",
    ...
    "todo.moreDetails": "Description, recurrence & labels",
    "todo.open": "Open",
    ...
    "expenses.inventoryMeta": "Renaming keeps existing expenses linked. Archive items to hide them from new expenses.",
...
export const DE_MESSAGES = Object.freeze({
    "workspaceSessions.reconnect": "Diesen Arbeitsbereich in den Einstellungen erneut verbinden.",
    "workspaceSessions.saveCountdown": "Speichern",
    "workspaceSessions.autosaveCountdown": "Automatisch in {seconds}s",
    "workspaceSessions.retryIn": "Erneut in {seconds}s",
    "workspaceSessions.retryCountdown": "Erneut",
    "workspaceSessions.reconnectAction": "Verbinden",
    "workspaceSessions.savingShort": "Speichert…",
    "workspaceSessions.autosaveHelp": "Jetzt speichern (Strg+S). Automatisches Speichern 60 Sekunden nach der letzten Änderung.",
    "workspaceSessions.saving": "Arbeitsbereiche werden gespeichert…",
    "workspaceSessions.changed": "Geändert · {count}",
    "workspaceSessions.all": "Alle Arbeitsbereiche",
    "workspaceSessions.workspace": "Arbeitsbereich",
    "workspaceSessions.loading": "Weitere Arbeitsbereiche werden geöffnet…",
    "workspaceSessions.closeTitle": "{workspace} schließen",
    "workspaceSessions.saveClose": "Speichern und schließen",
    "workspaceSessions.saveAll": "Alle offenen Arbeitsbereiche speichern",
    "workspaceSessions.saveFailed": "Speichern fehlgeschlagen · {workspaces}",
    "workspaceSessions.cancel": "Abbrechen",
    "workspaceSessions.pending": "Einige Änderungen konnten nicht gespeichert werden. Bitte den Fehler beheben und erneut versuchen.",
    "workspaceSessions.unavailable": "Nicht verfügbare Arbeitsbereiche: {workspaces}",
    "workTime.employer": "Arbeitgeber",
    "workTime.newEmployer": "Neuer Arbeitgeber",
    "workTime.outsideWeek": "diese Woche inaktiv",
    "workTime.addEmployer": "Arbeitgeber hinzufügen",
    "workTime.bulkStatus": "Status für Auswahl",
    "workTime.bulkHalf": "Tageshälften auswählen",
    "workTime.fullDay": "Ganzer Tag",
    "workTime.firstHalf": "Erste Hälfte",
    "workTime.secondHalf": "Zweite Hälfte",
    "workTime.selectWorkdays": "Geplante Arbeitstage auswählen",
    "workTime.applySelected": "Auf ausgewählte Tage anwenden",
    "workTime.select": "Auswahl",
    "workTime.day": "Tag",
    "workTime.scheduled": "Geplante Stunden",
    "workTime.required": "Sollstunden",
    "workTime.comment": "Kommentar",
    "workTime.work": "Arbeit",
    "workTime.pto": "Urlaub",
    "workTime.sick": "Krank",
    "workTime.holiday": "Feiertag",
    "workTime.flex": "Gleitzeit",
    "workTime.off": "Arbeitsfrei",
    "workTime.short.work": "Arbeit",
    "workTime.short.pto": "Urlaub",
    "workTime.short.sick": "Krank",
    "workTime.short.holiday": "Feiertag",
    "workTime.short.flex": "Gleitzeit",
    "workTime.short.off": "Frei",
    "workTime.employerCount": "{count} Arbeitgeber",
    "workTime.editDay": "Arbeit und Abwesenheit bearbeiten",
    "week.chooseDate": "Zu einem Datum springen",
    "week.date": "Datum",
    "week.goToDate": "Woche anzeigen",
    "workTime.flexHelp": "Gleitzeit lässt die Sollstunden unverändert. Nicht gearbeitete Stunden gehen vom Zeitkonto ab, nicht vom Urlaub.",
    "workTime.settings": "Arbeitgeber, Arbeitszeit & Urlaub",
    "workTime.name": "Arbeitgebername",
    "workTime.activeFrom": "Beschäftigung ab",
    "workTime.activeUntil": "Beschäftigung bis (optional)",
    "workTime.trackingStart": "Zeiterfassung ab",
    "workTime.openingOvertime": "Überstundenvortrag (Stunden)",
    "workTime.openingVacation": "Urlaubsvortrag (Tage)",
    "workTime.projects": "Zugeordnete Projekte",
    "workTime.filterProjects": "Projekte filtern",
    "workTime.schedules": "Arbeitszeitmodelle mit Gültigkeitsdatum",
    "workTime.effectiveFrom": "Gültig ab",
    "workTime.remove": "Entfernen",
    "workTime.addSchedule": "Arbeitszeitänderung hinzufügen",
    "workTime.allowances": "Jährlicher Urlaubsanspruch",
    "workTime.allowancesHelp": "Anspruch für jedes Jahr ausdrücklich eintragen. Resturlaub wird übertragen; Arbeitszeitänderungen passen den Anspruch nicht automatisch an.",
    "workTime.year": "Jahr",
    "workTime.addAllowance": "Jahr hinzufügen",
    "workTime.invalidYear": "Bitte ein Jahr zwischen 1900 und 2199 eingeben.",
    "workTime.adjustments": "Urlaubskorrekturen",
    "workTime.date": "Datum",
    "workTime.days": "Tage",
    "workTime.addAdjustment": "Korrektur hinzufügen",
    "workTime.billable": "Abrechenbar",
    "workTime.weekDelta": "Wochendifferenz bis heute",
    "workTime.overtime": "Überstunden gesamt",
    "workTime.vacationBalance": "Urlaubssaldo",
    "workTime.taken": "Genommen",
    "workTime.planned": "Geplant",
    "workTime.unplanned": "Ungeplant",
    "workTime.vacationCalculation": "So wird gerechnet",
    "workTime.vacationOverview": "Urlaubstage dieses Jahr",
    "workTime.vacationEmpty": "Für dieses Jahr ist kein Urlaub genommen oder geplant.",
    "workTime.vacationShowDate": "Diesen Tag im Tageseditor anzeigen (behält ungespeicherte Änderungen)",
    "workTime.vacationBudget": "Vortrag: {carryover} Tage · Anspruch: {allowance} Tage · Korrekturen: {adjustments} Tage",
    "workTime.vacationPlanningHelp": "Aktuelles Kalenderjahr, unabhängig von der angezeigten Woche. Genommen zählt bis einschließlich heute; Geplant zählt zukünftigen Urlaub; Ungeplant ist der Rest nach allen Buchungen. Nur geplante Arbeitstage zählen.",
    "workTime.missingAllowances": "Jahresanspruch noch nicht festgelegt für:",
    "workTime.noProjects": "Keine Projekte zugeordnet: Für diesen Arbeitgeber werden keine Arbeitszeiten angerechnet.",
    "workTime.legacyReadOnly": "Historische Wochensummen sind schreibgeschützt. Vor dem Bearbeiten der Arbeitgeberkonten direkt im Daten-Repository umwandeln.",
    "workTime.saving": "Speichern läuft bereits. Bitte warten.",
    ...
    "landing.openSharedWorkspace": "Geteilten Link / QR öffnen",
    ...
    "workspace.capabilityLink": "Zugriffslink",
    "workspace.scanQr": "QR scannen",
    "workspace.openCapability": "Link öffnen",
    "workspace.scanQrTitle": "Zugriffs-QR scannen",
    "workspace.scanQrHelp": "Richte die Rückkamera auf einen QR-Code mit einem zeitberg-Zugriffslink.",
    "workspace.stopScanning": "Scannen beenden",
    "workspace.qrImageHelp": "Keine Kamera? Wähle ein QR-Bild von diesem Gerät.",
    "workspace.chooseQrImage": "QR-Bild wählen",
    "workspace.connectManually": "oder manuell verbinden",
    "workspace.capabilityRequired": "Füge einen Zugriffslink ein oder scanne ihn.",
    "workspace.qrUnavailable": "Es ist keine Kamera verfügbar. Wähle stattdessen ein QR-Bild.",
    "workspace.qrImageError": "Aus diesem Bild konnte kein Zugriffs-QR gelesen werden: {error}",
    "workspace.qrCameraError": "Die Kamera konnte nicht gestartet werden: {error}",
    ...
    "workspace.capabilityHelp": "Verwendet die aktuellen Zugangsdaten dieses Browsers. Stelle sicher, dass sie nur die Rechte enthalten, die du teilen möchtest.",
    "workspace.copyCapability": "Zugriffslink kopieren",
    "workspace.capabilityHostedOnly": "Zugriffslinks sind nur für gehostete Arbeitsbereiche verfügbar.",
    "workspace.capabilityCredentialMissing": "Verbinde diesen Arbeitsbereich erneut, bevor du einen Zugriffslink teilst.",
    ...
    "todo.nonDueFallback": "Keine aktuellen Aufgaben entsprechen diesem Projektfilter. Aufgaben ohne aktuelle Fälligkeit werden angezeigt.",
    "demo.try": "Spielwiese ausprobieren — ohne Konto",
    "demo.title": "Spielwiese",
    "demo.notice": "Spielwiese · fiktive Daten · Änderungen verschwinden beim Neuladen",
    "demo.reset": "Zurücksetzen",
    "demo.exit": "Demo verlassen",
    "demo.noRepository": "Diese Spielwiese hat keine Repository-Verbindung. Verlasse die Demo, um deinen eigenen Arbeitsbereich zu verbinden.",
    ...
    "todo.moreDetails": "Beschreibung, Wiederholung & Labels",
    "todo.open": "Offen",
    ...
    "expenses.inventoryMeta": "Umbenennen erhält die Zuordnung bestehender Ausgaben. Archivierte Einträge werden bei neuen Ausgaben ausgeblendet.",
