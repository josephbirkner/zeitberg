...
export const EN_MESSAGES = Object.freeze({
    ...
    "landing.toGit": "> Git",
    "landing.lede": "zeitberg runs entirely in your browser. It reads and writes versioned files directly in a Git repository you choose; zeitberg.io stores no workspace data.",
    ...
    "landing.similarIntro": "We found no direct equivalent in our review. These projects overlap with zeitberg in scope or storage model.",
    ...
    "landing.notZoidbergTitle": "Not to be confused.",
    "landing.notZoidbergBody": "zeitberg is independent personal-organization software. Dr. Zoidberg is a fictional crustacean physician. The two are entirely unrelated.",
    "landing.notZoidbergAlt": "Dr. Zoidberg asks: Want your time tracking, TODOs, and expenses in Git? Why not Zeitberg?",
    "landing.notZoidbergAttribution": "Futurama and Dr. Zoidberg belong to their respective rights holders; zeitberg is not affiliated with them.",
    "landing.notZoidbergSource": "Meme template on Imgflip ↗",
    ...
    "workspace.configure": "Configure zeitberg.json",
    "workspace.configureMeta": "Choose the shared workspace identity and the component documents this repository provides.",
    "workspace.setupMissingMeta": "This repository has no {path} yet. Configure it here to enable its apps.",
    "workspace.setupInvalidMeta": "The existing {path} is not a valid workspace configuration. Saving here will repair it.",
    "workspace.workspaceId": "Workspace ID",
    "workspace.projectsPath": "Projects path",
    "workspace.timeComponent": "Time tracking",
    "workspace.entriesPath": "Week entries directory",
    "workspace.entriesManifestPath": "Entries manifest path",
    "workspace.requirementsPath": "Week requirements path",
    "workspace.todosComponent": "Tasks",
    "workspace.todosPath": "Tasks document path",
    "workspace.expensesComponent": "Expenses",
    "workspace.expensesPath": "Expenses document path",
    "workspace.expensesManifestPath": "Expenses manifest path",
    "workspace.initializeMissing": "Missing documents are initialized; existing data is kept unchanged.",
    "workspace.saveConfiguration": "Save configuration",
    "workspace.savingConfiguration": "Saving workspace configuration…",
    "workspace.configurationSaved": "Workspace configuration saved.",
    "workspace.enableComponent": "Enable at least one component.",
    "workspace.needsSetup": "Setup required",
    ...
    "expenses.composerMeta": "Record the purchase; balances update as you type.",
    ...
    "expenses.setupParticipantsTitle": "Who shares expenses?",
    "expenses.setupParticipantsMeta": "Add everyone who may pay or share an expense. Your expense will continue next.",
    ...
    "expenses.categorySuggested": "Suggested from similar expenses",
    "expenses.noCategory": "No category",
    "expenses.notes": "Notes",
    "expenses.paidByLabel": "Paid by",
    "expenses.multiplePayers": "Multiple payers",
    "expenses.choosePayer": "Choose a payer",
    "expenses.payerPanelTitle": "Who paid?",
    "expenses.payerPanelMeta": "Choose one payer or divide the payment.",
    "expenses.paymentMode": "Payment",
    "expenses.payerAmountSummary": "{participant} paid {amount}",
    "expenses.payersAmountSummary": "{count} people paid {amount}",
    "expenses.paymentIncomplete": "Payment still needs attention",
    "expenses.paymentAssigned": "The full {amount} is covered",
    "expenses.splitSummaryLabel": "Split",
    "expenses.splitEqualSummary": "Equally among {count} participants",
    "expenses.splitPercentageSummary": "Custom percentages",
    "expenses.splitSharesSummary": "Weighted shares",
    "expenses.splitExactSummary": "Exact amounts",
    "expenses.splitEqualPeople": "Equally: {people}",
    "expenses.splitPanelTitle": "Who shares it?",
    "expenses.splitPanelMeta": "Choose people and how much each person owes.",
    "expenses.peopleSummary": "{people} + {count} more",
    "expenses.enterAmountShort": "Enter the amount first",
    "expenses.eachAmount": "{amount} each",
    "expenses.splitIncomplete": "The split still needs attention",
    "expenses.overTotal": "{amount} over the total",
    "expenses.autoBalanceSummary": "{participant} pays the remaining {amount} automatically",
    "expenses.autoSplitSummary": "{participant} is assigned the remaining {amount} automatically",
    "expenses.splitAssigned": "The full {amount} is assigned",
    "expenses.result": "Result",
    "expenses.outcomeTitle": "After this expense",
    "expenses.outcomePrompt": "Enter an amount to preview who owes whom.",
    "expenses.outcomeIncomplete": "Finish the payment or split to see the result.",
    "expenses.outcomeEven": "Everyone is even after this expense.",
    "expenses.outcomeTransfer": "{from} owes {to} {amount}",
    "expenses.customizeSplit": "Customize payment and split",
    "expenses.customizeSplitMeta": "Use multiple payers, percentages, shares, or exact amounts.",
    "expenses.moreDetails": "More details",
    "expenses.moreDetailsMeta": "Project assignment and notes.",
    "expenses.createAction": "Add expense",
    "expenses.saveAction": "Save changes",
    ...
    "toast.expenseDate": "Choose a valid expense date.",
    "toast.expenseCurrency": "Use a three-letter currency code such as EUR.",
    ...
    "toast.expenseCategorySelection": "Choose an existing category or clear the category field.",
...
export const DE_MESSAGES = Object.freeze({
    ...
    "settings.meta": "Diese Einstellungen gelten nur in diesem Browser, nicht pro Arbeitsbereich.",
    ...
    "landing.toGit": "> Git",
    "landing.lede": "zeitberg läuft vollständig in Deinem Browser. Es liest und schreibt Deine Daten direkt in einem Git-Repository Deiner Wahl; zeitberg.io speichert nichts davon.",
    "landing.provider": "Anbieter",
    "landing.selfHostedForgejo": "Forgejo (selbst gehostet)",
    "landing.autoDetect": "Selbst gehosteten Git-Anbieter erkennen",
    "landing.workspaceRepository": "Workspace-Repository",
    "landing.branch": "Branch / Ref",
    "landing.accessToken": "Zugriffstoken",
    ...
    "landing.clearConnection": "Gespeicherte Verbindung vergessen",
    "landing.security": "Dein Token bleibt im Browser und wird nur an den gewählten Git-Anbieter gesendet.",
    "landing.architectureAlt": "zeitberg wird statisch geladen und läuft in Deinem Browser. Dein Browser liest und schreibt das private Workspace-Repository direkt über die API des Git-Anbieters.",
    "landing.architectureCaption": "Deine Zugangsdaten bleiben im Browser. Anfragen gehen direkt an den Git-Anbieter.",
    "landing.workspaceTitle": "Lege ein privates Daten-Repository an.",
    "landing.readOnlyPrefix": "Mit einem Read-only-Token kannst Du Daten ansehen. Zum Speichern brauchst Du",
    "landing.contentsPermission": "Contents: Read & write",
    "landing.createPrivateRepository": "Lege ein privates Repository an.",
    ...
    "landing.detailedSetup": "Anleitung ↗",
    "landing.connectExisting": "Verbinde ein bestehendes privates Repository mit einem Token.",
    "landing.createOther": "Oder erstelle oben einen privaten Arbeitsbereich auf GitLab.com oder Codeberg.",
    "landing.pkce": "OAuth mit PKCE funktioniert, wenn für diese Installation eine öffentliche Client-ID hinterlegt ist.",
    "landing.cors": "Selbst gehostete GitLab- und Forgejo-Server funktionieren, wenn sie Browserzugriffe per CORS erlauben.",
    "landing.similarTitle": "Ähnliche Projekte.",
    "landing.similarIntro": "Wir haben bei unserer Suche kein direktes Gegenstück gefunden. Diese Projekte ähneln zeitberg in einzelnen Bereichen oder bei der Datenspeicherung.",
    ...
    "landing.activityWatch": "Automatische Zeiterfassung mit Daten unter Deiner Kontrolle.",
    "landing.timeLocalFirst": "Zeit · Local-first",
    "landing.actualBudget": "Private Finanzverwaltung mit optionaler Synchronisierung.",
    "landing.financeLocalFirst": "Finanzen · Local-first",
    "landing.notZoidbergTitle": "Nicht zu verwechseln.",
    "landing.notZoidbergBody": "zeitberg ist eine unabhängige Software zur persönlichen Organisation. Dr. Zoidberg ist ein fiktiver Krustentierarzt. Beide stehen in keinerlei Verbindung.",
    "landing.notZoidbergAlt": "Dr. Zoidberg fragt auf Englisch: Want your time tracking, TODOs, and expenses in Git? Why not Zeitberg?",
    "landing.notZoidbergAttribution": "Futurama und Dr. Zoidberg gehören ihren jeweiligen Rechteinhabern; zeitberg steht mit ihnen in keiner Verbindung.",
    "landing.notZoidbergSource": "Meme-Vorlage auf Imgflip ↗",
    ...
    "landing.markAttribution": "Bildmarke und Landschaft sind von Hand erstellte SVGs. Dafür wurde kein Bildmodell verwendet.",
    ...
    "workspace.configure": "zeitberg.json konfigurieren",
    "workspace.configureMeta": "Lege die gemeinsame Identität und die Komponentendokumente dieses Repositorys fest.",
    "workspace.setupMissingMeta": "Dieses Repository hat noch keine {path}. Konfiguriere sie hier, um die Anwendungen zu aktivieren.",
    "workspace.setupInvalidMeta": "Die vorhandene {path} ist keine gültige Arbeitsbereichskonfiguration. Speichern repariert sie.",
    "workspace.workspaceId": "Arbeitsbereichs-ID",
    "workspace.projectsPath": "Projektpfad",
    "workspace.timeComponent": "Zeiterfassung",
    "workspace.entriesPath": "Verzeichnis der Wocheneinträge",
    "workspace.entriesManifestPath": "Pfad zum Eintragsmanifest",
    "workspace.requirementsPath": "Pfad zu den Wochenvorgaben",
    "workspace.todosComponent": "Aufgaben",
    "workspace.todosPath": "Pfad zum Aufgabendokument",
    "workspace.expensesComponent": "Ausgaben",
    "workspace.expensesPath": "Pfad zum Ausgabendokument",
    "workspace.expensesManifestPath": "Pfad zum Ausgabenmanifest",
    "workspace.initializeMissing": "Fehlende Dokumente werden angelegt; vorhandene Daten bleiben unverändert.",
    "workspace.saveConfiguration": "Konfiguration speichern",
    "workspace.savingConfiguration": "Arbeitsbereichskonfiguration wird gespeichert…",
    "workspace.configurationSaved": "Arbeitsbereichskonfiguration gespeichert.",
    "workspace.enableComponent": "Aktiviere mindestens eine Komponente.",
    "workspace.needsSetup": "Einrichtung erforderlich",
    "workspace.repositoryUrl": "Repository-URL",
    ...
    "expenses.composerMeta": "Kauf erfassen; die Salden aktualisieren sich während der Eingabe.",
    ...
    "expenses.setupParticipantsTitle": "Wer teilt Ausgaben?",
    "expenses.setupParticipantsMeta": "Füge alle hinzu, die Ausgaben bezahlen oder teilen können. Danach geht es direkt mit der Ausgabe weiter.",
    ...
    "expenses.descriptionPlaceholder": "Wofür war diese Ausgabe?",
    "expenses.date": "Datum",
    "expenses.amount": "Betrag",
    "expenses.currency": "Währung",
    "expenses.category": "Kategorie",
    "expenses.categorySuggested": "Aus ähnlichen Ausgaben vorgeschlagen",
    "expenses.noCategory": "Keine Kategorie",
    "expenses.notes": "Notizen",
    "expenses.paidByLabel": "Bezahlt von",
    "expenses.multiplePayers": "Mehrere Zahlende",
    "expenses.choosePayer": "Zahlende Person auswählen",
    "expenses.payerPanelTitle": "Wer hat bezahlt?",
    "expenses.payerPanelMeta": "Eine zahlende Person wählen oder die Zahlung aufteilen.",
    "expenses.paymentMode": "Zahlung",
    "expenses.payerAmountSummary": "{participant} hat {amount} bezahlt",
    "expenses.payersAmountSummary": "{count} Personen haben {amount} bezahlt",
    "expenses.paymentIncomplete": "Die Zahlung braucht noch Aufmerksamkeit",
    "expenses.paymentAssigned": "Der gesamte Betrag von {amount} ist abgedeckt",
    "expenses.splitSummaryLabel": "Aufteilung",
    "expenses.splitEqualSummary": "Gleichmäßig auf {count} Personen",
    "expenses.splitPercentageSummary": "Individuelle Prozente",
    "expenses.splitSharesSummary": "Gewichtete Anteile",
    "expenses.splitExactSummary": "Exakte Beträge",
    "expenses.splitEqualPeople": "Gleichmäßig: {people}",
    "expenses.splitPanelTitle": "Wer teilt die Ausgabe?",
    "expenses.splitPanelMeta": "Personen auswählen und festlegen, welchen Anteil sie tragen.",
    "expenses.peopleSummary": "{people} + {count} weitere",
    "expenses.enterAmountShort": "Zuerst den Betrag eingeben",
    "expenses.eachAmount": "Je {amount}",
    "expenses.splitIncomplete": "Die Aufteilung braucht noch Aufmerksamkeit",
    "expenses.overTotal": "{amount} über dem Gesamtbetrag",
    "expenses.autoBalanceSummary": "{participant} übernimmt automatisch den Restbetrag von {amount}",
    "expenses.autoSplitSummary": "{participant} wird automatisch der Restbetrag von {amount} zugeordnet",
    "expenses.splitAssigned": "Der gesamte Betrag von {amount} ist verteilt",
    "expenses.result": "Ergebnis",
    "expenses.outcomeTitle": "Nach dieser Ausgabe",
    "expenses.outcomePrompt": "Betrag eingeben, um zu sehen, wer wem etwas schuldet.",
    "expenses.outcomeIncomplete": "Zahlung oder Aufteilung vervollständigen, um das Ergebnis zu sehen.",
    "expenses.outcomeEven": "Nach dieser Ausgabe sind alle ausgeglichen.",
    "expenses.outcomeTransfer": "{from} schuldet {to} {amount}",
    "expenses.customizeSplit": "Zahlung und Aufteilung anpassen",
    "expenses.customizeSplitMeta": "Mehrere Zahlende, Prozente, Anteile oder exakte Beträge verwenden.",
    "expenses.moreDetails": "Weitere Angaben",
    "expenses.moreDetailsMeta": "Projektzuordnung und Notizen.",
    "expenses.createAction": "Ausgabe hinzufügen",
    "expenses.saveAction": "Änderungen speichern",
    ...
    "toast.expenseDate": "Wähle ein gültiges Ausgabedatum.",
    "toast.expenseCurrency": "Verwende einen dreistelligen Währungscode wie EUR.",
    ...
    "toast.expenseCategorySelection": "Wähle eine vorhandene Kategorie oder leere das Kategoriefeld.",
